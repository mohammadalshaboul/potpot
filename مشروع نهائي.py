...
# إعداد Flask لتشغيل سيرفر ويب يبقي البوت شغال
app = Flask(__name__)
...
if __name__ == '__main__':
    threading.Thread(target=run).start()  # تشغيل Flask في Thread
    print("Bot is starting...")
    bot.infinity_polling()  # بدء عمل البوت
...
class PDF(FPDF):
    ...
    def add_text(self, text):
        ...
        self.multi_cell(0, 10, reshaped_text, align='R')
...
def handle_text(message):
    ...
    if mode == "text":
        # رفض النصوص التي تحتوي على رموز خاصة
